...
## 6.2 Mechanisms: Diffusion, Advection, Reaction
...
## 6.3 Finite Differences and the Shallow Water Equations
...
[Unit 7](../unit_07/unit_07.qmd) and as the horizontal driver for the
column model in [Unit 8](../unit_08/unit_08.qmd).
