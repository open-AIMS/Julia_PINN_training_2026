...
for $\eta$, one for $u$). This is the case where de Wolff et al.
(2021) reported a *negative* result: vanilla PINN underperformed a
pure data-driven NN. We reproduce the failure to motivate the fixes
in §8.3.
