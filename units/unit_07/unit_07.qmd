...
| `Optimization.solve(prob, opt; maxiters)` | Optimization | Minimises that loss. Idiom: a few hundred steps of `Adam()` to get into the basin, then `LBFGS()` to polish — exactly what §7.1 does. |
