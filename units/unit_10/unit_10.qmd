...
because the data set is small (5 sensors × 720 hourly samples) and the
...
[Unit 9 §9.9](../unit_09/unit_09.qmd#sec-task-a). The rising edge is
...
- **Adaptive loss weighting** (gradient-balancing —
  [McClenny & Braga-Neto 2022](../references/references.qmd#ref-mcclenny2022){target="_blank"})
  for the surface-flux BC and the residual.
- **Causal training**
  ([Wang et al. 2022](../references/references.qmd#ref-wang2022causal){target="_blank"})
  — residual losses at later times weighted by how well earlier
  times have already converged.
...
Three sub-scale prototypes per the [Unit 9 §9.10](../unit_09/unit_09.qmd#sec-task-b)
checklist:
